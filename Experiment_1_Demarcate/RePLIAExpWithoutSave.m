function RePLIAExpWithoutSave(COMMAND_SETTING,OUT_FILENAME)
...
%SAVEDATA
COMMAND_EXP_WRITE = 'cd tmp/channels;python expwrite.py';
%GETDATA
COMMAND_DATA_FILE = '/media/ramdisk/out.lid';
%Output filename
